...
function CodeView() {
    ...
    return (
        <div className='relative'>
            ...
            {!isReady && (
                <div className='p-10 bg-gray-900 absolute top-0 rounded-lg w-full h-[80vh] flex items-center justify-center'>
                    <Loader2Icon className='animate-spin h-10 w-10 text-white'/>
                    <h2 className='text-white ml-2'>Loading workspace...</h2>
                </div>
            )}
